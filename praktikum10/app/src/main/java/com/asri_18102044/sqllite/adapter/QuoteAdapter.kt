package com.asri_18102044.sqllite.adapter
...
import com.asri_18102044.sqllite.QuoteAddUpdateActivity
import com.asri_18102044.sqllite.R
import com.asri_18102044.sqllite.data.Quote
import com.asri_18102044.sqllite.databinding.ItemQuoteBinding
...
class QuoteAdapter(private val activity: Activity):
    ...
    inner class QuoteViewHolder(itemView: View) :
        ...
        fun bind(quote: Quote, position: Int) {
            ...
            binding.tvItemReview.text = quote.review
            binding.tvItemDuration.text = quote.duration
